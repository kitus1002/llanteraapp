-- 1. Tabla de Festivos (Asegurar que existe y tiene UNIQUE en fecha)
...
-- PARCHE: Si la tabla fue creada por el script 01, no tenía UNIQUE en fecha. Se lo agregamos.
ALTER TABLE cat_festivos DROP CONSTRAINT IF EXISTS cat_festivos_fecha_key;
ALTER TABLE cat_festivos ADD CONSTRAINT cat_festivos_fecha_key UNIQUE (fecha);
