...
CREATE TABLE IF NOT EXISTS cat_causas_baja_imss (
    ...
    clave TEXT NOT NULL UNIQUE, -- e.g. "1", "2"
    descripcion TEXT NOT NULL,
    activo BOOLEAN DEFAULT TRUE
);

-- Asegurarse de que la restricción UNIQUE existe si la tabla ya había sido creada sin ella
ALTER TABLE cat_causas_baja_imss DROP CONSTRAINT IF EXISTS cat_causas_baja_imss_clave_key;
ALTER TABLE cat_causas_baja_imss ADD CONSTRAINT cat_causas_baja_imss_clave_key UNIQUE (clave);
