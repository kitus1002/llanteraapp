-- =========================================================================
-- PASO 2 DE 13 — MÓDULO CHECADOR (Fase 2)
-- Nombre: SQL_CHECADOR_FASE_2.sql
-- Descripción: Turnos, checadas, tipos de checada (6 tipos), dispositivos,
--              permisos_autorizados, auditoria_logs, QR token en empleados.
