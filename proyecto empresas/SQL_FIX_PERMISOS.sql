-- =========================================================================
-- PASO 3 DE 13 — PARCHE RLS: PERMISOS CRUD COMPLETO
-- Nombre: SQL_FIX_PERMISOS.sql
-- Descripción: Agrega políticas INSERT/DELETE en permisos_autorizados
--              y CRUD completo en turnos. Sin esto el admin no puede
--              generar ni borrar códigos de permiso.
